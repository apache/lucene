...
The `:lucene:benchmark-jmh` module can be used to compile and execute JMH (<https://github.com/openjdk/jmh>)
micro-benchmarks.

Look at existing classes and JMH documentation for inspiration on how to write good micro-benchmarks.
...
The above target will display exact commands to execute JMH from command line.
...
This one is a little rough because they removed the Makefile so you have to bring it back from the dead. Otherwise you
