...
dpu-clang -g -DTEST1 -DSTACK_SIZE_DEFAULT=512 -DNR_TASKLETS=16 -I ../inc/ ../src/dpu.c ../src/decoder.c ../src/matcher.c ../src/parser.c ../src/query_parser.c ../src/term_lookup.c -o test_phrase
