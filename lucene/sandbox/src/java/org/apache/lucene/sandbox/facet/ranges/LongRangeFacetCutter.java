...
public abstract class LongRangeFacetCutter extends RangeFacetCutter {
    ...
    public static LongRangeFacetCutter create(String field, MultiLongValuesSource longValuesSource,
        ...
        if (areOverlappingRanges(longRanges)) {
            return new OverlappingLongRangeFacetCutter(field, longValuesSource, singleLongValuesSource, longRanges);
        }
        return new ExclusiveLongRangeFacetCutter(field, longValuesSource, singleLongValuesSource, longRanges);
    }
    ...
    LongRangeFacetCutter(String field, MultiLongValuesSource longValuesSource, LongValuesSource singleLongValuesSource,
    ...
    static abstract class LongRangeMultivaluedFacetLeafCutter implements FacetLeafCutter {
        ...
        LongRangeMultivaluedFacetLeafCutter(MultiLongValues longValues, long[] boundaries, int[] pos, int requestedRangeCount) {
    ...
    static abstract class LongRangeSinglevaluedFacetLeafCutter implements FacetLeafCutter {
