...
public final class HnswBitVectorsFormat extends KnnVectorsFormat {
  ...
  public HnswBitVectorsFormat(
    ...
    this.flatVectorsFormat = new Lucene99FlatVectorsFormat(new OnHeapFlatBitVectorsScorer());
  }
  ...
  public KnnVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new Lucene99HnswVectorsWriter(
        ...
        maxConn,
        beamWidth,
        new FlatBitVectorsWriter(flatVectorsFormat.fieldsWriter(state)),
        numMergeWorkers,
        mergeExec);
  }
  ...
  public String toString() {
    return "Lucene99HnswBitVectorsFormat(name=Lucene99HnswBitVectorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ", flatVectorFormat="
  ...
  private static class FlatBitVectorsWriter extends FlatVectorsWriter {
    private final FlatVectorsWriter delegate;

    public FlatBitVectorsWriter(FlatVectorsWriter delegate) {
      super(new OnHeapFlatBitVectorsScorer());
    ...
    public FlatFieldVectorsWriter<?> addField(
      ...
      if (fieldInfo.getVectorEncoding() != VectorEncoding.BYTE) {
        throw new IllegalArgumentException(
            "Lucene99HnswBitVectorsFormat only supports BYTE encoding");
      }
