...
/**
 * This listener listens for every field configuration request and assign a {@link
 * ConfigurationKeys#DATE_RESOLUTION} to the equivalent {@link FieldConfig} based on a defined map:
 * fieldName -&gt; {@link Resolution} stored in {@link ConfigurationKeys#FIELD_DATE_RESOLUTION_MAP}.
 *
...
public class FieldDateResolutionFCListener implements FieldConfigListener {
  ...
  public void buildFieldConfig(FieldConfig fieldConfig) {
    ...
    Map<CharSequence, DateTools.Resolution> dateResMap =
