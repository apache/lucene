...
public class TestPointQueryParser extends LuceneTestCase {
  ...
  public void testIntegers() throws Exception {
    ...
    pointsConfig.put(
        "intField", new PointsConfig(NumberFormat.getIntegerInstance(Locale.ROOT), Integer.class));
  ...
  public void testLongs() throws Exception {
    ...
    Map<String, PointsConfig> pointsConfig = new HashMap<>();
    pointsConfig.put(
        "longField", new PointsConfig(NumberFormat.getIntegerInstance(Locale.ROOT), Long.class));
    parser.setPointsConfigMap(pointsConfig);
  ...
  public void testFloats() throws Exception {
    ...
    Map<String, PointsConfig> pointsConfig = new HashMap<>();
    pointsConfig.put(
        "floatField", new PointsConfig(NumberFormat.getNumberInstance(Locale.ROOT), Float.class));
    parser.setPointsConfigMap(pointsConfig);
  ...
  public void testDoubles() throws Exception {
    ...
    Map<String, PointsConfig> pointsConfig = new HashMap<>();
    pointsConfig.put(
        "doubleField", new PointsConfig(NumberFormat.getNumberInstance(Locale.ROOT), Double.class));
    parser.setPointsConfigMap(pointsConfig);

    assertEquals(
        DoublePoint.newRangeQuery("doubleField", 1.5D, 3.6D),
        parser.parse("doubleField:[1.5 TO 3.6]", "body"));
    assertEquals(
        DoublePoint.newRangeQuery("doubleField", 1.5D, 1.5D),
