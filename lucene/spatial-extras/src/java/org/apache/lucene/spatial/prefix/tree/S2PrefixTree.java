...
/**
 * Spatial prefix tree for <a href="https://s2geometry.io/">S2 Geometry</a>. Shape factories for the
 * given {@link SpatialContext} must implement the interface {@link S2ShapeFactory}.
 *
 * <p>The tree can be configured on how it divided itself by providing an arity. The default arity
 * is 1 which divided every sub-cell in 4 (except the first level that is always divided by 6) .
 * Arity 2 divides sub-cells in 16 and arity 3 in 64 sub-cells.
 *
 * @lucene.experimental
 */
public class S2PrefixTree extends SpatialPrefixTree {
  ...
  protected static class Factory extends SpatialPrefixTreeFactory {
    ...
    protected SpatialPrefixTree newSPT() {
      return new S2PrefixTree(ctx, maxLevels != null ? maxLevels : S2PrefixTree.getMaxLevels(1));
    }
  }
