...
public class TestToken extends LuceneTestCase {
  ...
  public static final class SenselessAttributeImpl extends AttributeImpl
      implements SenselessAttribute {
    @Override
    ...
    public boolean equals(Object o) {
      return (o instanceof SenselessAttributeImpl);
    }
  ...
  public void testTokenAttributeFactory() throws Exception {
    ...
    assertTrue(
        "FlagsAttribute is not implemented by Token",
        ts.addAttribute(FlagsAttribute.class) instanceof Token);
    assertTrue(
        "PayloadAttribute is not implemented by Token",
