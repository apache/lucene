...
public class TestFloatingPointUlpEquality extends LuceneTestCase {
    private static void testDoubleEqualsWithAllowedUlps() {
        ...
        assertFalse(doubleUlpEquals(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Integer.MAX_VALUE));
    ...
    private static void testFloatEqualsWithAllowedUlps() {
