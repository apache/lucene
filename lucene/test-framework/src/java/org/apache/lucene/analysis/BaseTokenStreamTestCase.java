...
public abstract class BaseTokenStreamTestCase extends LuceneTestCase {
  ...
  public static void assertTokenStreamContents(
    ...
    if (output.length > 0) {
      ...
      if (false == Objects.equals(bytesAtt.getClass().getSimpleName(), "BytesRefBuilderTermAttributeImpl")) {
        assertSame("TermToBytesRefAttribute must be implemented by same instance", termAtt, bytesAtt);
      }
    }
