 ...
 *
 * <p>This analyzer is a replacement for Whitespace/Simple/KeywordAnalyzers for unit tests. If you
 ...
 *
 * <ul>
 *   <li>By default, the assertions in {@link MockTokenizer} are turned on for extra checks that the
 *       consumer is consuming properly. These checks can be disabled with {@link
 *       #setEnableChecks(boolean)}.
 *   <li>Payload data is randomly injected into the stream for more thorough testing of payloads.
 * </ul>
 *
 * @see MockTokenizer
 */
