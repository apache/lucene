...
public class RandomIndexWriter implements Closeable {
  ...
  /**
   * Interface for a function that creates an IndexWriter from an IndexWriterConfig and can throw an
   * IOException
   */
  ...
  private static IndexWriter mockIndexWriter(
      Directory dir, IndexWriterConfig conf, Random r, IndexWriterInstanceCreator creator)
      throws IOException {
    // Randomly calls Thread.yield so we mixup thread scheduling
    final Random random = new Random(r.nextLong());
    return mockIndexWriter(
  ...
  private static IndexWriter mockIndexWriter(
      ...
      TestPoint testPoint,
      IndexWriterInstanceCreator createWriter)
      throws IOException {
  ...
  /**
   * Returns an indexwriter that enables the specified test point The indexwriter is of class
   * IndexWriter
   */
  ...
  /**
   * create a RandomIndexWriter with a random config: Uses MockAnalyzer Uses an
   * IndexWriterInstanceCreator to create the indexwriter
   */
  public RandomIndexWriter(Random r, Directory dir, IndexWriterInstanceCreator creator)
      throws IOException {
    this(
        r,
        dir,
  ...
  /**
   * create a RandomIndexWriter with a random config Uses an IndexWriterInstanceCreator to create
   * the indexwriter
   */
  public RandomIndexWriter(Random r, Directory dir, Analyzer a, IndexWriterInstanceCreator creator)
      throws IOException {
    this(r, dir, LuceneTestCase.newIndexWriterConfig(r, a), false, r.nextBoolean(), creator);
  }

  /**
   * create a RandomIndexWriter with the provided config Uses an IndexWriterInstanceCreator to
   * create the indexwriter
   */
  public RandomIndexWriter(
      Random r, Directory dir, IndexWriterConfig c, IndexWriterInstanceCreator creator)
      throws IOException {
