...
final class TestRuleSetupAndRestoreClassEnv extends AbstractBeforeAfterRule {
  ...
  protected void before() throws Exception {
    ...
    } else if ("Lucene98".equals(TEST_CODEC)
        || ("random".equals(TEST_CODEC) && randomVal == 5 && !shouldAvoidCodec("Lucene98"))) {
      codec = new Lucene98Codec(RandomPicks.randomFrom(random, Lucene98Codec.Mode.values()));
