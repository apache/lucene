...
public abstract class BasePostingsFormatTestCase extends BaseIndexFileFormatTestCase {
  ...
  public void testBinarySearchTermLeaf() throws Exception {
    ...
    BytesRef target1 = new BytesRef(100003 + "");
    assertTrue(termsEnum.seekExact(target1));
    assertEquals(termsEnum.term(), target1);
    BytesRef target2 = new BytesRef(100001 + "");
    assertTrue(termsEnum.seekExact(target2));
    assertEquals(termsEnum.term(), target2);
