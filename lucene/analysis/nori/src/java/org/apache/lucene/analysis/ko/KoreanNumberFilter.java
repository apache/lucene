 ...
 * FULL STOP), is removed from the token stream, this filter would find input tokens ３ and ２천
 ...
 * </ul>
 *
 * <p>Tokens preceded by a token with {@link PositionIncrementAttribute} of zero are left
