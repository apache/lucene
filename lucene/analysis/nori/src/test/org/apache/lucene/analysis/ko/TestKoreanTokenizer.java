...
public class TestKoreanTokenizer extends BaseTokenStreamTestCase {
  ...
  public void testReading() throws IOException {
    ...
    assertAnalyzesTo(
        ...
        new int[] {1});
    assertAnalyzesTo(
        analyzerReading, "가늘라", new String[] {"가늘라"}, new int[] {0}, new int[] {3}, new int[] {1});
  }
  ...
  public void testUserDict() throws IOException {
    ...
    assertAnalyzesTo(
        analyzer, "대한민국날씨", new String[] {"대한민국날씨"}, new int[] {0}, new int[] {6}, new int[] {1});
  ...
  public void testCombining() throws IOException {
    ...
    assertAnalyzesTo(
        analyzer, "εἰμί", new String[] {"εἰμί"}, new int[] {0}, new int[] {4}, new int[] {1});
    assertPartsOfSpeech(
        analyzer,
        "εἰμί",
        new POS.Type[] {POS.Type.MORPHEME},
