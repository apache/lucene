...
public class TestJapaneseCompletionFilter extends BaseTokenStreamTestCase {
  ...
  public void testCompletionIndex() throws IOException {
    assertAnalyzesTo(indexAnalyzer, "東京", new String[] {"東京", "toukyou"}, new int[] {1, 0});

    assertAnalyzesTo(
        indexAnalyzer, "東京都", new String[] {"東京", "toukyou", "都", "to"}, new int[] {1, 0, 1, 0});
    ...
    assertAnalyzesTo(indexAnalyzer, "々", new String[] {"々"}, new int[] {1});

    assertAnalyzesTo(indexAnalyzer, "是々", new String[] {"是", "ze", "々"}, new int[] {1, 0, 1});

    assertAnalyzesTo(
        indexAnalyzer, "是々の", new String[] {"是", "ze", "々", "の", "no"}, new int[] {1, 0, 1, 1, 0});
  }

  @Test
  public void testCompletionQuery() throws IOException {
    assertAnalyzesTo(queryAnalyzer, "東京", new String[] {"東京", "toukyou"}, new int[] {1, 0});

    assertAnalyzesTo(
        queryAnalyzer, "東京都", new String[] {"東京", "toukyou", "都", "to"}, new int[] {1, 0, 1, 0});
    ...
    assertAnalyzesTo(
        queryAnalyzer, "ソースコード", new String[] {"ソースコード", "soーsukoーdo"}, new int[] {1, 0});
    ...
    assertAnalyzesTo(queryAnalyzer, "々", new String[] {"々"}, new int[] {1});

    assertAnalyzesTo(queryAnalyzer, "是々", new String[] {"是", "ze", "々"}, new int[] {1, 0, 1});

    assertAnalyzesTo(
        indexAnalyzer, "是々の", new String[] {"是", "ze", "々", "の", "no"}, new int[] {1, 0, 1, 1, 0});

    assertAnalyzesTo(queryAnalyzer, "東京ｔ", new String[] {"東京t", "toukyout"}, new int[] {1, 0});

    assertAnalyzesTo(queryAnalyzer, "サッｋ", new String[] {"サッk", "sakk"}, new int[] {1, 0});

    assertAnalyzesTo(
        queryAnalyzer, "反ｓｙ", new String[] {"反sy", "hansy", "hannsy"}, new int[] {1, 0, 0});
