...
class GeneratingSuggester {
  ...
  static class Provider implements DictionarySuggester {
    @Override
    public List<String> suggest(
        Hunspell speller,
        SuggestibleEntryCache entryCache,
        String word,
        WordCase originalCase,
        Set<Suggestion> prevSuggestions) {
      return new GeneratingSuggester(speller, entryCache)
          .suggest(word, originalCase, prevSuggestions);
    }
  }
