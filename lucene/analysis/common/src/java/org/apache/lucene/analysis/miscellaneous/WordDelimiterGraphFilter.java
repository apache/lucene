 ...
 * in the search-time analyzer. Unlike the now removed <code>WordDelimiterFilter</code>, this token
 * filter produces a correct token graph as output. However, it cannot consume an input token graph
