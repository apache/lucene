...
public class TestSolrSynonymParser extends BaseSynonymParserTestCase {
  ...
  public void testSimple() throws Exception {
    ...
    assertAnalyzesTo(
        analyzer, "i-pod", new String[] {"i-pod", "ipod", "ipoooood"}, new int[] {1, 0, 0});
