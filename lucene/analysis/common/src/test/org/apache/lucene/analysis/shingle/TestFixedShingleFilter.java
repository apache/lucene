...
public class TestFixedShingleFilter extends BaseTokenStreamTestCase {
  ...
  public void testBiGramFilterWithAltSeparator() throws IOException {
    ...
    assertTokenStreamContents(
        new FixedShingleFilter(ts, 2, "<SEP>", "_"),
        new String[] {
          "please<SEP>divide",
          "divide<SEP>this",
          "this<SEP>sentence",
  ...
  public void testShingleSizeGreaterThanTokenstreamLength() throws IOException {
    ...
    TokenStream ts =
        new FixedShingleFilter(
            new CannedTokenStream(new Token("please", 0, 6), new Token("divide", 7, 13)), 3);
  ...
  public void testTrailingStopwords() throws IOException {
    ...
    TokenStream ts =
        new CannedTokenStream(
            1, 7, new Token("b", 0, 1), new Token("c", 2, 3), new Token("d", 4, 5));
  ...
  public void testMultipleTrailingStopwords() throws IOException {
    ...
    TokenStream ts =
        new CannedTokenStream(
            2, 9, new Token("b", 0, 1), new Token("c", 2, 3), new Token("d", 4, 5));
  ...
  public void testTrailingGraphsOfDifferingLengths() throws IOException {
    ...
    assertTokenStreamContents(
        new FixedShingleFilter(ts, 3), new String[] {"a b f", "a c d", "c d e", "d e f"});
  }
