...
public class TestTeeSinkTokenFilter extends BaseTokenStreamTestCase {
  ...
  public void setUp() throws Exception {
    ...
    tokens1 =
        new String[] {
          "The", "quick", "Burgundy", "Fox", "jumped", "over", "the", "lazy", "Red", "Dogs"
        };
  ...
  public void testGeneral() throws IOException {
    final TeeSinkTokenFilter source =
        new TeeSinkTokenFilter(whitespaceMockTokenizer(buffer1.toString()));
  ...
  public void testMultipleSources() throws Exception {
    ...
    MockTokenizer tokenizer =
        new MockTokenizer(tee1.getAttributeFactory(), MockTokenizer.WHITESPACE, false);
  ...
  public void performance() throws Exception {
    ...
    for (int k = 0; k < tokCount.length; k++) {
      ...
      for (int i = 0; stream.incrementToken(); i++) {
        ...
        assertTrue(
            tfTok + " is not equal to " + sinkTok + " at token: " + i,
      ...
      for (int j = 0; j < modCounts.length; j++) {
        ...
        for (int i = 0; i < 20; i++) {
          ...
          PositionIncrementAttribute posIncrAtt =
              teeStream.getAttribute(PositionIncrementAttribute.class);
