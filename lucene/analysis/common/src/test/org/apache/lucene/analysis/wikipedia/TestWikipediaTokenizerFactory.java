...
public class TestWikipediaTokenizerFactory extends BaseTokenStreamFactoryTestCase {
  ...
  public void testTokenizerTokensOnly() throws Exception {
    String text = "This is a [[Category:foo]]";
    Tokenizer tf =
        tokenizerFactory(WIKIPEDIA, TOKEN_OUTPUT, Integer.toString(WikipediaTokenizer.TOKENS_ONLY))
  ...
  public void testIllegalArguments() throws Exception {
    ...
    assertTrue(
        expected
            .getMessage()
            .contains("tokenOutput must be TOKENS_ONLY, UNTOKENIZED_ONLY or BOTH"));
  }
}
