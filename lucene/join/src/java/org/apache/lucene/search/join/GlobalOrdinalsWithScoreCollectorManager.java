...
class GlobalOrdinalsWithScoreCollectorManager<
        C extends GlobalOrdinalsWithScoreCollectorManager.GlobalOrdinalsWithScoreCollector>
    implements CollectorManager<
        C, GlobalOrdinalsWithScoreCollectorManager.GlobalOrdinalsWithScoreResult> {
  private final Supplier<C> collectorSupplier;

  public GlobalOrdinalsWithScoreCollectorManager(Supplier<C> collectorSupplier) {
  ...
  @Override
  public GlobalOrdinalsWithScoreResult reduce(Collection<C> collectors) throws IOException {
    C reducedCollector = collectorSupplier.get();
    for (C collector : collectors) {
      reducedCollector.merge(collector);
    }
    return reducedCollector;
  }

  interface GlobalOrdinalsWithScoreResult {
    boolean match(int ordinal);
  ...
  abstract static class GlobalOrdinalsWithScoreCollector
      implements Collector, GlobalOrdinalsWithScoreResult {
    ...
    @Override
    public LongBitSet collectedOrds() {
