...
public class ToParentBlockJoinFloatKnnVectorQuery extends KnnFloatVectorQuery {
    ...
    TopDocs results =
        context
            ...
            .searchNearestVectors(
                field, new ToParentJoinKnnResults.Provider(k), acceptDocs, visitedLimit);
    return results != null ? results : NO_RESULTS;
    return super.approximateSearch(context, acceptDocs, visitedLimit);
  }
      ...
      return new ScorerSupplier() {
        ...
        public Scorer get(long leadCost) throws IOException {
          return new BlockJoinScorer(
              ToParentBlockJoinFloatKnnVectorQuery.BlockJoinWeight.this,
  ...
  public Query rewrite(IndexSearcher indexSearcher) throws IOException {
    ...
    if (childRewrite != childQuery) {
      return new ToParentBlockJoinFloatKnnVectorQuery(childRewrite, parentsFilter, scoreMode);
    } else {
  ...
  private boolean equalsTo(ToParentBlockJoinFloatKnnVectorQuery other) {
