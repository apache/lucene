...
/**
 * Wraps {@link Lucene103PostingsFormat} format for on-disk storage, but then at read time loads and
...
public final class DirectPostingsFormat extends PostingsFormat {
  ...
  public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
    return PostingsFormat.forName("Lucene103").fieldsConsumer(state);
  }

  @Override
  public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
    FieldsProducer postings = PostingsFormat.forName("Lucene103").fieldsProducer(state);
