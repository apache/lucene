...
import static org.apache.lucene.codecs.simpletext.SimpleTextNumericVectorsWriter.*;
 ...
 * @lucene.experimental
 */
public class SimpleTextNumericVectorsReader extends NumericVectorsReader {
  // shallowSizeOfInstance for fieldEntries map is included in ramBytesUsed() calculation
  private static final long BASE_RAM_BYTES_USED =
      RamUsageEstimator.shallowSizeOfInstance(SimpleTextNumericVectorsReader.class)
  ...
  SimpleTextNumericVectorsReader(SegmentReadState readState) throws IOException {
    this.readState = readState;
    String metaFileName =
        IndexFileNames.segmentFileName(
            readState.segmentInfo.name,
            readState.segmentSuffix,
            SimpleTextNumericVectorsFormat.META_EXTENSION);
    String vectorFileName =
        IndexFileNames.segmentFileName(
            readState.segmentInfo.name,
            readState.segmentSuffix,
            SimpleTextNumericVectorsFormat.VECTOR_EXTENSION);
