 ...
 * @lucene.experimental
 */
public final class SimpleTextNumericVectorsFormat extends NumericVectorsFormat {

  @Override
  public NumericVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new SimpleTextNumericVectorsWriter(state);
  }

  @Override
  public NumericVectorsReader fieldsReader(SegmentReadState state) throws IOException {
    return new SimpleTextNumericVectorsReader(state);
  }
