...
public class SimpleTextFieldInfosFormat extends FieldInfosFormat {
  ...
  public FieldInfos read(
    ...
    try {
      ...
      for (int i = 0; i < size; i++) {
        ...
        NnVectors.SimilarityFunction vectorDistFunc = distanceFunction(scoreFunction);
  ...
  public NnVectors.SimilarityFunction distanceFunction(String scoreFunction) {
    return NnVectors.SimilarityFunction.valueOf(scoreFunction);
  }
  ...
  public void write(
    ...
    try {
      ...
      for (FieldInfo fi : infos) {
        ...
        SimpleTextUtil.write(out, Integer.toString(fi.getNnVectorDimension()), scratch);
        SimpleTextUtil.writeNewline(out);
