...
public class LongAggregationsFacetRecorder implements FacetRecorder {
    ...
    /** TODO */
    public LongAggregationsFacetRecorder(LongValuesSource[] longValuesSource, LongAggregationFunction[] aggregationFunctions) {
    }
    ...
    private static final class RunningAggregation {
        LongAggregationFunction relevanceCombiner;
        /** Per ordinal values **/
        final IntLongMap values;

        private RunningAggregation(IntLongMap values, LongAggregationFunction relevanceCombiner) {
        ...
        long applyCombiner(long left, long right) {
            return relevanceCombiner.aggregate(left, right);
        }
