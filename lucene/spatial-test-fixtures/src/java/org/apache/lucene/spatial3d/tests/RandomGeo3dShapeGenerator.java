 ...
 * expressed as a shape and a relationship.
 *
 * <p>note that convexity for polygons is defined as polygons that contains antipodal points,
...
public final class RandomGeo3dShapeGenerator {
  ...
  /**
   * Method that returns a random generated a random Shape code from all supported shapes.
   *
  ...
  /**
   * Method that returns a random generated GeoAreaShape code from all supported GeoAreaShapes.
   *
   * <p>We are removing Collections because it is difficult to create shapes with properties in some
   * cases.
   *
  ...
  /**
   * Method that returns a random generated a random Shape code from all convex supported shapes.
   *
  ...
  /**
   * Method that returns a random generated a random Shape code from all concave supported shapes.
   *
  ...
  /**
   * Method that returns a random generated GeoPoint under given constraints. Returns NULL if it
   * cannot find a point under the given constraints.
   *
   * @param planetModel The planet model.
  ...
  /**
   * Method that returns a random generated GeoAreaShape under given constraints. Returns NULL if it
   * cannot build the GeoAreaShape under the given constraints.
   *
   * @param shapeType The GeoAreaShape code.
   * @param planetModel The planet model.
   * @param constraints The given constraints.
  ...
  /**
   * Method that returns a random generated a GeoPath under given constraints. Returns NULL if it
   * cannot build the GeoPath under the given constraints.
   *
   * @param planetModel The planet model.
   * @param constraints The given constraints.
  ...
  /**
   * Method that returns a random generated a convex square GeoPolygon under given constraints.
   * Returns NULL if it cannot build the convex GeoPolygon under the given constraints. This shape
   * is an utility to build constraints.
   *
   * @param planetModel The planet model.
   * @param constraints The given constraints.
  ...
  /**
   * Method that returns a random list of generated GeoPoints under given constraints. The number of
   * points returned might be lower than the requested.
   *
  ...
  /**
   * Check if a GeoPolygon is pure concave. Note that our definition for concavity is that the
   * polygon contains antipodal points.
   *
   * @param planetModel The planet model.
  ...
  /**
   * Check if a GeoPolygon is pure convex. Note that our definition for convexity is that the
   * polygon does not contain antipodal points.
   *
   * @param planetModel The planet model.
   * @param shape The polygon to check.
