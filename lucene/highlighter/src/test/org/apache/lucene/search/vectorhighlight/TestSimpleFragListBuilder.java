...
public class TestSimpleFragListBuilder extends AbstractTestCase {
  ...
  public void testSmallerFragSizeThanTermQuery() throws Exception {
    ...
    assertEquals(
        "subInfos=(abcdefghijklmnopqrs((0,19)))/1.0(0,19)", ffl.getFragInfos().get(0).toString());
  }
  ...
  public void testSmallerFragSizeThanPhraseQuery() throws Exception {
    ...
    assertEquals(
        "subInfos=(abcdefghjklmnopqrs((0,21)))/1.0(0,21)", ffl.getFragInfos().get(0).toString());
  }
  ...
  public void test1PhraseLongMV() throws Exception {
    ...
    assertEquals(1, ffl.getFragInfos().size());
    assertEquals(
        "subInfos=(searchengines((102,116))searchengines((157,171)))/2.0(87,187)",
