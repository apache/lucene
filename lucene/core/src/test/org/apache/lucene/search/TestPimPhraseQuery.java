...
public class TestPimPhraseQuery extends LuceneTestCase {
    ...
    public static void beforeClass() throws Exception {
        ...
        if(pimMode)
            indexCreator = getIndexCreator(directory, pimDirectory, pimConfig);
        else
            indexCreator = getIndexCreator(directory);
        ...
        if(pimMode)
            assert PimSystemManager.get().loadPimIndex(pimDirectory);
    }
    ...
    public void testPhraseQueryWithStopAnalyzer() throws Exception {
        ...
        RandomIndexWriter writer =
                new RandomIndexWriter(random(), directory, newIndexWriterConfig(stopAnalyzer), indexCreator);
        Document doc = new Document();
    ...
    private static RandomIndexWriter.IndexWriterInstanceCreator
    getIndexCreator(Directory dir, Directory pimDir, PimConfig pimConf) {
        return (conf) -> {
    ...
    public void testPhraseQueryInConjunctionScorer() throws Exception {
        ...
        writer =
                new RandomIndexWriter(
                        random(),
                        directory,
                        newIndexWriterConfig(new MockAnalyzer(random())).setOpenMode(IndexWriterConfig.OpenMode.CREATE), indexCreator);
        doc = new Document();
        ...
        RandomIndexWriter writer =
                new RandomIndexWriter(
                        ...
                        newIndexWriterConfig(new MockAnalyzer(random()))
                                ...
                                .setSimilarity(new BM25Similarity()), indexCreator);
    ...
    public void testZeroPosIncr() throws IOException {
        ...
        if(pimMode) {
            ...
            indexCreator = getIndexCreator(dir);
    ...
    public void testRandomPhrases() throws Exception {
        ...
        RandomIndexWriter w =
                new RandomIndexWriter(
                        random(), dir, newIndexWriterConfig(analyzer).setMergePolicy(newLogMergePolicy()), indexCreator);
    ...
    public void testNullTerm() {
        ...
        e = expectThrows(NullPointerException.class, () -> new PimPhraseQuery("field", (BytesRef) null));
        assertEquals("Cannot add a null term to PhraseQuery", e.getMessage());
