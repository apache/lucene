...
public class TestSortRandom extends LuceneTestCase {
  ...
  private void testRandomStringSort(SortField.Type type) throws Exception {
    ...
    final IndexSearcher s = newSearcher(r, false, random.nextBoolean(), random.nextBoolean());
    ...
    public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost)
      ...
      return new ConstantScoreWeight(this, boost) {
        ...
        public ScorerSupplier scorerSupplier(LeafReaderContext context) throws IOException {
          ...
          // partition iterates
          // through its own set of doc ids, using a separate iterator backed by the shared bitset.
          final var scorer =
