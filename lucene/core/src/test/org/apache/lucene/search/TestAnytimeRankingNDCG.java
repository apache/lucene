...
public class TestAnytimeRankingNDCG extends LuceneTestCase {
    ...
    public void testNDCGDoesNotDiverge() throws Exception {
        ...
        AnytimeRankingSearcher anytime =
                new AnytimeRankingSearcher(baseline, 10, 5, "field");
        ...
        System.out.printf(Locale.ROOT, "baselineNDCG=%.3f anytimeNDCG=%.3f%n", baselineNDCG, anytimeNDCG);
