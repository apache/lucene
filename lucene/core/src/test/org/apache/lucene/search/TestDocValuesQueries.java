...
public class TestDocValuesQueries extends LuceneTestCase {
  ...
  public void testDocValueQueryWhenFieldNameIsAlsoUsedForPoints() throws IOException {
    ...
    // its one document, whether the doc-values were written as raw double bits (as Solr does) or
    // via DoubleDocValuesField (as Lucene does), and whether or not the query is wrapped in an
