 ...
 *
 * <p>Mostly forked and trimmed from com.carrotsearch.hppc.IntArrayListTest
 *
 * <p>github: https://github.com/carrotsearch/hppc release: 0.9.0
 */
public class TestIntArrayList extends LuceneTestCase {
  private final int key0 = cast(0);
  private final int key1 = cast(1);
  private final int key2 = cast(2);
  private final int key3 = cast(3);
  private final int key4 = cast(4);
  private final int key5 = cast(5);
  private final int key6 = cast(6);
  private final int key7 = cast(7);
  ...
  public void testEqualsSameClass() {
    ...
    IntArrayList l3 = IntArrayList.from(key1, key3, key2);
  ...
  public void testEqualsSubClass() {
    ...
    IntArrayList l1 = IntArrayList.from(key1, key2, key3);
    IntArrayList l2 = new Sub();
    IntArrayList l3 = new Sub();
    l2.addAll(l1);
    l3.addAll(l1);
  ...
  public void testStream() {
    ...
    expectThrows(
        ...
        () -> {
          IntArrayList.from().stream().min().orElseThrow();
        });
  }
  ...
  private static void assertListEquals(int[] array, int... elements) {
