...
public class TestSegmentMerger extends LuceneTestCase {
  ...
  public void setUp() throws Exception {
    ...
    reader1 = new SegmentReader(info1, Version.LATEST.major, newReadIOContext(random()));
    reader2 = new SegmentReader(info2, Version.LATEST.major, newReadIOContext(random()));
  }
