...
public class TestKnnGraph extends LuceneTestCase {
  ...
  //  /**
  //   * Verify that we get the *same* graph by indexing one segment as we do by indexing two
  // segments
  //   * and merging.
  //   */
  ...
  //        assertArrayEquals("difference at ord=" + node, expected[level][node],
  // actual[level][node]);
  //      }
  //    }
  //  }
  ...
  //      iwc.setMergePolicy(new LogDocMergePolicy()); // for predictable segment ordering when
  // merging
