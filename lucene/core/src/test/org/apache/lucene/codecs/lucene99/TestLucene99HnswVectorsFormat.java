...
public class TestLucene99HnswVectorsFormat extends BaseKnnVectorsFormatTestCase {
  ...
  public void testToString() {
    ...
    String expectedPattern =
        "Lucene99HnswVectorsFormat(name=Lucene99HnswVectorsFormat, maxConn=10, beamWidth=20, bypassTinySegments=false, flatVectorFormat=Lucene99FlatVectorsFormat(vectorsScorer=%s()))";
