    ...
    Lucene93Codec customCodec =
        new Lucene93Codec() {
          ...
          public KnnVectorsFormat getKnnVectorsFormatForField(String field) {
            return new Lucene93HnswVectorsFormat(10, 20, VectorEncoding.FLOAT32);
          }
        };
    String expectedString =
        "Lucene93HnswVectorsFormat(name=Lucene93HnswVectorsFormat, maxConn=10, beamWidth=20, vectorEncoding=FLOAT32)";
