...
/**
 * Unit tests for {@link BinMapWriter} and {@link BinMapReader} using {@link DocBinningGraphBuilder}.
 */
public class TestBinMapReaderWriter extends LuceneTestCase {
    ...
    public void testBinMapWriteAndRead() throws IOException {
        ...
        BinMapWriter writer = new BinMapWriter(writeState.directory, writeState,
                docToBin, numBins);
    ...
    public void testEmptySegment() throws IOException {
        ...
        SegmentInfo emptyInfo = new SegmentInfo(
                directory,
                Version.LATEST,
                Version.LATEST,
                "_empty",
        ...
        SegmentWriteState emptyWriteState = new SegmentWriteState(null, directory, emptyInfo, null, null, IOContext.DEFAULT);
        SegmentReadState emptyReadState = new SegmentReadState(directory, emptyInfo, null, IOContext.DEFAULT);

        int[] emptyBinArray = {/*nothing in here = array with no slots*/};

        // Nothing to write since maxDoc is 0, but simulate writing header
        BinMapWriter writer = new BinMapWriter(emptyWriteState.directory, emptyWriteState, emptyBinArray, 0);
        writer.close();
