...
public class TestLucene912BinaryFlatVectorsScorer extends LuceneTestCase {
  public void testScore() throws IOException {
    ...
    byte[] vector = new byte[] {-8, 10, -27, 112, -83, 36, -36, -122, -114, 82, 55, 33, -33, 120, 55, -99, -93, -86, -55, 21, -121, 30, 111, 30, 0, 82, 21, 38, -120, -127, 40, -32, 78, -37, 42, -43, 122, 115, 30, 115, 123, 108, -13, -65, 123, 124, -33, -68, 49, 5, 20, 58, 0, 12, 30, 30, 4, 97, 10, 66, 4, 35, 1, 67};  // FIXME: add value
    ...
    assertEquals(245482.47f, scorer.score(0), 0.001f);
  }
}
