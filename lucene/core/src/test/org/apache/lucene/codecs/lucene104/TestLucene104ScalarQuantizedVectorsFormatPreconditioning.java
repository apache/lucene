...
import org.apache.lucene.codecs.PreconditioningKnnVectorsFormat;
...
/**
 * Tests for rotation preconditioning via {@link PreconditioningKnnVectorsFormat} wrapping {@link
...
public class TestLucene104ScalarQuantizedVectorsFormatPreconditioning extends LuceneTestCase {
  ...
  private static Codec codecWithRotation(ScalarEncoding encoding) {
    ...
    KnnVectorsFormat rotated = PreconditioningKnnVectorsFormat.rotating(base);
