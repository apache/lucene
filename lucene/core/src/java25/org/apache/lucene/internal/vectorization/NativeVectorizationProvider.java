...
public final class NativeVectorizationProvider extends VectorizationProvider {
  ...
  private final VectorizationProvider delegateVectorUtilProvider = new PanamaVectorizationProvider();

  private final VectorUtilSupport vectorUtilSupport;

  NativeVectorizationProvider() {
    vectorUtilSupport = new NativeVectorUtilSupport(delegateVectorUtilProvider.getVectorUtilSupport());
    logIncubatorSetup();
  }
