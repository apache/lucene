...
public class RegexpQuery extends AutomatonQuery {
   ...
   *     eventually use {@link org.apache.lucene.util.automaton.ByteNFARunAutomaton} to execute.
   *     Notice that {@link org.apache.lucene.util.automaton.ByteNFARunAutomaton} is not
   *     thread-safe, so better to avoid rewritten method like {@link
   *     #CONSTANT_SCORE_BLENDED_REWRITE} when searcher is configured with an executor service
   */
  public RegexpQuery(
      Term term,
      int syntaxFlags,
