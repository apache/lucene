  ...
  public NumericDocValues getNorms(FieldInfo field) throws IOException {
    ...
    return new FilterNumericDocValues(values) {
      ...
      public int nextDoc() throws IOException {
        // advanceExact() may have left the cursor past the range without moving the values it
        // wraps, so stop here rather than stepping an iterator that is still behind us.
        if (doc >= end) {
