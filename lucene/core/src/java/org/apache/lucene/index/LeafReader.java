...
public abstract non-sealed class LeafReader extends IndexReader {
  ...
  /**
   * Returns {@link RandomAccessInputDocValues} for this field, or null if no binary doc values were
   * indexed for this field. The returned instance should only be used by a single thread.
   */
  public abstract RandomAccessInputDocValues getRandomAccesInputDocValues(String field)
      throws IOException;
