...
public abstract class VectorValues extends DocIdSetIterator {
   ...
   * this field, to the given vector, by the field's similarity function. If the similarity is
  ...
  public enum SimilarityFunction {
    ...
    /**
     * No similarity function is provided. Note: {@link VectorValues#search(float[], int, int)} is
