...
/**
 * Quantized vector writer that requires specialize merging logic.
 *
 * @lucene.experimental
 */
public interface QuantizedVectorsWriter {
  /**
   ...
   */
  CloseableRandomVectorScorerSupplier mergeOneFieldToIndex(
