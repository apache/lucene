 ...
 *
 * <p>{@code toString(Accountable}} can be used to quickly debug the nested structure of any
 * Accountable.
 *
 * <p>The {@code namedAccountable} and {@code namedAccountables} methods return type-safe,
...
public class Accountables {
   ...
   *
   * <p>The resource descriptions are constructed in this format: {@code description [toString()]}
   *
   * <p>This is a point-in-time type safe view: consumers will not be able to cast or manipulate the
   ...
   */
  public static Accountable namedAccountable(
      final String description, final Collection<Accountable> children, final long bytes) {
