...
public final class Version {
  ...
  /**
   * @deprecated (9.2.1) Use latest
   */
  @Deprecated
  public static final Version LUCENE_9_2_0 = new Version(9, 2, 0);

  /**
   * Match settings and bugs in Lucene's 9.2.1 release.
   * <p>Use this to get the latest &amp; greatest settings, bug fixes, etc, for Lucene.
   */
  public static final Version LUCENE_9_2_1 = new Version(9, 2, 1);
   ...
   */
  public static final Version LATEST = LUCENE_9_2_1;
