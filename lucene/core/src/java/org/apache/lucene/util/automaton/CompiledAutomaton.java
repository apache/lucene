...
public class CompiledAutomaton implements Accountable {
   ...
   * it as {@link #automaton}. Returns {@code false} for {@link AUTOMATON_TYPE#NONE},
   * {@link AUTOMATON_TYPE#ALL} and {@link AUTOMATON_TYPE#SINGLE} -- those short-circuit
   * and keep no reference -- and for {@code isBinary=false} construction, where the
   * internal automaton is a distinct UTF-8 conversion of the input.
   *
