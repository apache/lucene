 ...
 *   <li>In version 10.0, compound files got aligned on 4kB pages in order to not store multiple
 *       files on the same page, in-turn allowing them to get different {@link
 *       org.apache.lucene.store.ReadAdvice read advices}.
 * </ul>
 *
 * <a id="Limitations"></a>
 *
