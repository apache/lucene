 ...
 * @lucene.experimental
 */
public final class Lucene104FlatVectorsReader extends FlatVectorsReader {

  private static final long SHALLOW_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(Lucene104FlatVectorsFormat.class);
  ...
  public Lucene104FlatVectorsReader(SegmentReadState state, FlatVectorsScorer scorer)
      throws IOException {
    super(scorer);
      ...
      try {
        versionMeta =
            CodecUtil.checkIndexHeader(
                ...
                Lucene104FlatVectorsFormat.VERSION_START,
  ...
  public long ramBytesUsed() {
    return Lucene104FlatVectorsReader.SHALLOW_SIZE + fields.ramBytesUsed();
  }
