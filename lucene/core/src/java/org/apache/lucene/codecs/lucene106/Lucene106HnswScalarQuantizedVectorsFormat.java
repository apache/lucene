 ...
 * quantized using {@link Lucene106ScalarQuantizedVectorsFormat} before being stored in the graph.
 *
 * @lucene.experimental
 */
public class Lucene106HnswScalarQuantizedVectorsFormat extends KnnVectorsFormat {

  public static final String NAME = "Lucene106HnswBinaryQuantizedVectorsFormat";
  ...
  private final Lucene106ScalarQuantizedVectorsFormat flatVectorsFormat;
  ...
  public Lucene106HnswScalarQuantizedVectorsFormat() {
    this(
   ...
   */
  public Lucene106HnswScalarQuantizedVectorsFormat(int maxConn, int beamWidth) {
    this(
        ScalarEncoding.UNSIGNED_BYTE,
        maxConn,
        beamWidth,
  ...
  public Lucene106HnswScalarQuantizedVectorsFormat(
      ...
      int tinySegmentsThreshold) {
    super(NAME);
    flatVectorsFormat = new Lucene106ScalarQuantizedVectorsFormat(encoding, enableCentering);
  ...
  public String toString() {
    return "Lucene106HnswScalarQuantizedVectorsFormat(name=Lucene106HnswScalarQuantizedVectorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ", tinySegmentsThreshold="
