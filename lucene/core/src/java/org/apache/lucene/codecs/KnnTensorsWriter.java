...
/** Writes tensors to an index. */
public abstract class KnnTensorsWriter implements Accountable, Closeable {

  /** Sole constructor */
  protected KnnTensorsWriter() {}

  /** Add new field for indexing */
  public abstract KnnFieldTensorsWriter<?> addField(FieldInfo fieldInfo) throws IOException;
...
//        break;
  ...
  /**
   * Merges the segment tensors for all fields. This default implementation delegates to {@link
   * #mergeOneField}, passing a {@link KnnTensorsReader} that combines the tensor values and ignores
   * deleted documents.
   */
  public final void merge(MergeState mergeState) throws IOException {
    for (int i = 0; i < mergeState.fieldInfos.length; i++) {
      KnnTensorsReader reader = mergeState.knnTensorsReaders[i];
