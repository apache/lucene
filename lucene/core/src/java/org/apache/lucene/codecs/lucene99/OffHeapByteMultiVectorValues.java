...
/** Read multiVector values from the index input. This supports both iterated and random access. */
public abstract class OffHeapByteMultiVectorValues extends ByteVectorValues
  ...
  public OffHeapByteMultiVectorValues(
      int dimension,
      int size,
      IndexInput slice,
      IndexInput dataIn,
  ...
  public static OffHeapByteMultiVectorValues load(
  ...
  public static class DenseOffHeapMultiVectorValuesWithOffsets
    ...
    public DenseOffHeapMultiVectorValuesWithOffsets(
        ...
        FlatVectorsScorer flatMultiVectorScorer,
        MultiVectorSimilarityFunction similarityFunction,
        LongValues vectorDataOffsets)
        throws IOException {
      super(dimension, size, slice, null, flatMultiVectorScorer, similarityFunction, null);
      dataOffsets = vectorDataOffsets;
    }
  ...
  private static class SparseOffHeapMultiVectorValues extends OffHeapByteMultiVectorValues {
  ...
  private static class EmptyOffHeapMultiVectorValues extends OffHeapByteMultiVectorValues {
