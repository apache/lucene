...
public abstract class OffHeapByteVectorValues extends ByteVectorValues implements HasIndexSlice {
  ...
  public static class DenseOffHeapVectorValues extends OffHeapByteVectorValues {
    public DenseOffHeapVectorValues(
        ...
        FlatVectorsScorer flatVectorsScorer,
        VectorSimilarityFunction vectorSimilarityFunction) {
      super(dimension, size, slice, byteSize, flatVectorsScorer, vectorSimilarityFunction, null);
    }
    ...
    public DenseOffHeapVectorValues(
        ...
        VectorSimilarityFunction vectorSimilarityFunction,
        long[] offsets) {
      super(dimension, size, slice, byteSize, flatVectorsScorer, vectorSimilarityFunction, offsets);
    }
