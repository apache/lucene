 ...
 * files, and requires a {@link Lucene99FlatMultiVectorsFormat} to store the actual vectors:
 *
 * @lucene.experimental
 */
public final class Lucene99HnswMultiVectorsFormat extends KnnVectorsFormat {

  public static final String NAME = "Lucene99HnswMultiVectorsFormat";
  ...
  private static final FlatVectorsFormat flatVectorsFormat =
      new Lucene99FlatMultiVectorsFormat(DefaultFlatMultiVectorScorer.INSTANCE);

  private final int numMergeWorkers;
  private final TaskExecutor mergeExec;

  /** Constructs a format using default graph construction parameters */
  public Lucene99HnswMultiVectorsFormat() {
   ...
   */
  public Lucene99HnswMultiVectorsFormat(int maxConn, int beamWidth) {
