...
/**
 * Lucene 10.0 compound file format
 *
 * <p>Files:
 *
 * <ul>
 ...
 *       aligned to 4096 bytes to avoid storing multiple files on the same OS page.
 * </ul>
 */
public final class Lucene100CompoundFormat extends CompoundFormat {
  ...
  private static final int ASSUMED_PAGE_SIZE_IN_BYTES = 4_096;

  /** Sole constructor. */
  public Lucene100CompoundFormat() {}

  @Override
  public CompoundDirectory getCompoundReader(Directory dir, SegmentInfo si, IOContext context)
      throws IOException {
    return new Lucene100CompoundReader(dir, si, context);
  }
  ...
  private static record SizedFile(String name, long length) {}
