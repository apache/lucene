...
import org.apache.lucene.codecs.hnsw.DefaultFlatMultiVectorScorer;
...
public final class Lucene99HnswTensorsFormat extends KnnTensorsFormat {
  ...
  /** The format for storing, reading, merging tensors on disk */
  private static final FlatVectorsFormat flatVectorsFormat =
      new Lucene99FlatTensorsFormat(new DefaultFlatMultiVectorScorer());

  private final int numMergeWorkers;
  private final TaskExecutor mergeExec;

  /** Constructs a format using default graph construction parameters */
  public Lucene99HnswTensorsFormat() {
   ...
   */
  public Lucene99HnswTensorsFormat(int maxConn, int beamWidth) {
   ...
   * @param mergeExec the {@link ExecutorService} that will be used by ALL tensor writers that are
  ...
  public Lucene99HnswTensorsFormat(
    ...
    super("Lucene99HnswTensorsFormat");
  ...
  public String toString() {
    return "Lucene99HnswTensorsFormat(name=Lucene99HnswTensorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ", flatVectorFormat="
