...
import static org.apache.lucene.codecs.lucene104.Lucene104HnswVectorsFormat.DIRECT_MONOTONIC_BLOCK_SHIFT;
import static org.apache.lucene.codecs.lucene104.Lucene104HnswVectorsFormat.HNSW_GRAPH_THRESHOLD;
import static org.apache.lucene.codecs.lucene104.Lucene104HnswVectorsFormat.VERSION_CURRENT;
import static org.apache.lucene.codecs.lucene104.Lucene104HnswVectorsFormat.VERSION_GROUPVARINT;
import static org.apache.lucene.codecs.lucene104.Lucene104HnswVectorsReader.SIMILARITY_FUNCTIONS;
 ...
 * @lucene.experimental
 */
public final class Lucene104HnswVectorsWriter extends KnnVectorsWriter {

  private static final long SHALLOW_RAM_BYTES_USED =
      RamUsageEstimator.shallowSizeOfInstance(Lucene104HnswVectorsWriter.class);
  ...
  public Lucene104HnswVectorsWriter(
  ...
  Lucene104HnswVectorsWriter(
    ...
    String metaFileName =
        IndexFileNames.segmentFileName(
            state.segmentInfo.name, state.segmentSuffix, Lucene104HnswVectorsFormat.META_EXTENSION);

    String indexDataFileName =
        IndexFileNames.segmentFileName(
            state.segmentInfo.name,
            state.segmentSuffix,
            Lucene104HnswVectorsFormat.VECTOR_INDEX_EXTENSION);
    ...
    try {
      ...
      CodecUtil.writeIndexHeader(
          meta,
          Lucene104HnswVectorsFormat.META_CODEC_NAME,
          version,
          state.segmentInfo.getId(),
          state.segmentSuffix);
      CodecUtil.writeIndexHeader(
          vectorIndex,
          Lucene104HnswVectorsFormat.VECTOR_INDEX_CODEC_NAME,
          version,
          state.segmentInfo.getId(),
          state.segmentSuffix);
    } catch (Throwable t) {
