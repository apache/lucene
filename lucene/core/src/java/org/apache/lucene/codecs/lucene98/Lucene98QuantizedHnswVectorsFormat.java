 ...
 * @lucene.experimental
 */
public final class Lucene98QuantizedHnswVectorsFormat extends KnnVectorsFormat {

  static final String META_CODEC_NAME = "Lucene98QuantizedHnswVectorsFormatMeta";
  static final String VECTOR_DATA_CODEC_NAME = "Lucene98QuantizedHnswVectorsFormatData";
  static final String VECTOR_INDEX_CODEC_NAME = "Lucene98QuantizedHnswVectorsFormatIndex";
  static final String QUANTIZED_VECTOR_DATA_CODEC_NAME = "Lucene98QuantizedHnswVectorsFormatQuantizedData";
   ...
   * {@link Lucene98QuantizedHnswVectorsFormat#DEFAULT_MAX_CONN}. See {@link HnswGraph} for more details.
   */
  private final int maxConn;

  /**
   * The number of candidate neighbors to track while searching the graph for each newly inserted
   * node. Defaults to to {@link Lucene98QuantizedHnswVectorsFormat#DEFAULT_BEAM_WIDTH}. See {@link
   * HnswGraph} for details.
   */
  private final int beamWidth;

  /** Constructs a format using default graph construction parameters */
  public Lucene98QuantizedHnswVectorsFormat() {
   ...
   */
  public Lucene98QuantizedHnswVectorsFormat(int maxConn, int beamWidth) {
  ...
  public KnnVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new Lucene98QuantizedHnswVectorsWriter(state, maxConn, beamWidth);
  }

  @Override
  public KnnVectorsReader fieldsReader(SegmentReadState state) throws IOException {
    return new Lucene98QuantizedHnswVectorsReader(state);
  }
  ...
  public String toString() {
    return "Lucene98QuantizedHnswVectorsFormat(name=Lucene98QuantizedHnswVectorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ")";
