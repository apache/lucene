 ...
 * @lucene.experimental
 */
public final class Lucene104HnswVectorsFormat extends KnnVectorsFormat {

  static final String META_CODEC_NAME = "Lucene104HnswVectorsFormatMeta";
  static final String VECTOR_INDEX_CODEC_NAME = "Lucene104HnswVectorsFormatIndex";
   ...
   * {@link Lucene104HnswVectorsFormat#DEFAULT_MAX_CONN}. See {@link HnswGraph} for more details.
   */
  private final int maxConn;

  /**
   * The number of candidate neighbors to track while searching the graph for each newly inserted
   * node. Defaults to {@link Lucene104HnswVectorsFormat#DEFAULT_BEAM_WIDTH}. See {@link HnswGraph}
   * for details.
   */
  ...
  private static final FlatVectorsFormat flatVectorsFormat =
      new Lucene104FlatVectorsFormat(FlatVectorScorerUtil.getLucene99FlatVectorsScorer());
   ...
   * Lucene104HnswVectorsFormat#HNSW_GRAPH_THRESHOLD}).
   *
   * <ul>
  ...
  public Lucene104HnswVectorsFormat() {
    this(
        DEFAULT_MAX_CONN,
        DEFAULT_BEAM_WIDTH,
   ...
   */
  public Lucene104HnswVectorsFormat(int maxConn, int beamWidth) {
   ...
   */
  public Lucene104HnswVectorsFormat(int maxConn, int beamWidth, int tinySegmentsThreshold) {
    this(
  ...
  Lucene104HnswVectorsFormat(
      ...
      int tinySegmentsThreshold,
      int writeVersion) {
    super("Lucene104HnswVectorsFormat");
  ...
  public KnnVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new Lucene104HnswVectorsWriter(
        state,
        maxConn,
        beamWidth,
  ...
  public KnnVectorsReader fieldsReader(SegmentReadState state) throws IOException {
    return new Lucene104HnswVectorsReader(state, flatVectorsFormat.fieldsReader(state));
  }
  ...
  public String toString() {
    return "Lucene104HnswVectorsFormat(name=Lucene104HnswVectorsFormat, maxConn="
        + maxConn
        + ", beamWidth="
        + beamWidth
        + ", tinySegmentsThreshold="
