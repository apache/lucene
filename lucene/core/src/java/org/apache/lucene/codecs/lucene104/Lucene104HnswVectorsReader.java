 ...
 * @lucene.experimental
 */
public final class Lucene104HnswVectorsReader extends KnnVectorsReader
    implements QuantizedVectorsReader, HnswGraphProvider {

  private static final long SHALLOW_SIZE =
      RamUsageEstimator.shallowSizeOfInstance(Lucene104HnswVectorsFormat.class);
  ...
  public Lucene104HnswVectorsReader(SegmentReadState state, FlatVectorsReader flatVectorsReader)
      throws IOException {
      ...
      try {
        versionMeta =
            CodecUtil.checkIndexHeader(
                ...
                Lucene104HnswVectorsFormat.VERSION_START,
                Lucene104HnswVectorsFormat.VERSION_CURRENT,
  ...
  private Lucene104HnswVectorsReader(
      Lucene104HnswVectorsReader reader, FlatVectorsReader flatVectorsReader) {
    this.flatVectorsReader = flatVectorsReader;
  ...
  public KnnVectorsReader getMergeInstance() throws IOException {
    return new Lucene104HnswVectorsReader(this, this.flatVectorsReader.getMergeInstance());
  }
  ...
  public long ramBytesUsed() {
    return Lucene104HnswVectorsReader.SHALLOW_SIZE
        + fields.ramBytesUsed()
  ...
  public Map<String, Long> getOffHeapByteSize(FieldInfo fieldInfo) {
    ...
    var graph = Map.of(Lucene104HnswVectorsFormat.VECTOR_INDEX_EXTENSION, entry.vectorIndexLength);
