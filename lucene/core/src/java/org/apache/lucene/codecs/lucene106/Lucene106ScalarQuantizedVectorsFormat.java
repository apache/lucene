 ...
 * @lucene.experimental
 */
public class Lucene106ScalarQuantizedVectorsFormat extends FlatVectorsFormat {
  public static final String QUANTIZED_VECTOR_COMPONENT = "QVEC";
  public static final String NAME = "Lucene106ScalarQuantizedVectorsFormat";

  static final int VERSION_START = 0;
  static final int VERSION_CURRENT = VERSION_START;
  static final String META_CODEC_NAME = "Lucene106ScalarQuantizedVectorsFormatMeta";
  static final String VECTOR_DATA_CODEC_NAME = "Lucene106ScalarQuantizedVectorsFormatData";
  ...
  private static final Lucene106ScalarQuantizedVectorScorer scorer =
      new Lucene106ScalarQuantizedVectorScorer(FlatVectorScorerUtil.getLucene99FlatVectorsScorer());

  private final ScalarEncoding encoding;
  private final boolean enableCentering;

  /** Creates a new instance with UNSIGNED_BYTE encoding and centering enabled. */
  public Lucene106ScalarQuantizedVectorsFormat() {
    this(ScalarEncoding.UNSIGNED_BYTE);
  }

  /** Creates a new instance with the chosen quantization encoding and centering enabled. */
  public Lucene106ScalarQuantizedVectorsFormat(ScalarEncoding encoding) {
    this(encoding, true);
  }
   ...
   */
  public Lucene106ScalarQuantizedVectorsFormat(ScalarEncoding encoding, boolean enableCentering) {
    super(NAME);
  ...
  public FlatVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new Lucene106ScalarQuantizedVectorsWriter(
        state, encoding, enableCentering, rawVectorFormat.fieldsWriter(state), scorer);
  }

  @Override
  public FlatVectorsReader fieldsReader(SegmentReadState state) throws IOException {
    return new Lucene106ScalarQuantizedVectorsReader(
  ...
  public String toString() {
    return "Lucene106ScalarQuantizedVectorsFormat(name="
        + NAME
        + ", encoding="
        + encoding
        + ", enableCentering="
