 ...
 * @lucene.experimental
 */
public final class Lucene105PostingsFormat extends PostingsFormat {
  ...
  public static Class<? extends ImpactsEnum> getImpactsEnumImpl() {
    return Lucene105PostingsReader.BlockPostingsEnum.class;
  }

  static final String TERMS_CODEC = "Lucene105PostingsWriterTerms";
  static final String META_CODEC = "Lucene105PostingsWriterMeta";
  static final String DOC_CODEC = "Lucene105PostingsWriterDoc";
  static final String POS_CODEC = "Lucene105PostingsWriterPos";
  static final String PAY_CODEC = "Lucene105PostingsWriterPay";
  ...
  public Lucene105PostingsFormat() {
    this(
   ...
   */
  public Lucene105PostingsFormat(int minTermBlockSize, int maxTermBlockSize) {
    this(minTermBlockSize, maxTermBlockSize, VERSION_CURRENT);
  }

  /** Expert constructor that allows setting the version. */
  public Lucene105PostingsFormat(int minTermBlockSize, int maxTermBlockSize, int version) {
    super("Lucene105");
  ...
  public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
    PostingsWriterBase postingsWriter = new Lucene105PostingsWriter(state, version);
    try {
  ...
  public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
    PostingsReaderBase postingsReader = new Lucene105PostingsReader(state);
    try {
  ...
  /**
   * Holds all state required for {@link Lucene105PostingsReader} to produce a {@link
