...
public final class ForUtil {
  ...
  static void decode4(PostingDecodingUtil pdu, int[] ints) throws IOException {
    pdu.splitInts(64, ints, 4, 4, MASK8_4, ints, 64, MASK8_4);
  }

  static void decode5(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(80, ints, 3, 5, MASK8_5, tmp, 0, MASK8_3);
  ...
  static void decode6(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(96, ints, 2, 6, MASK8_6, tmp, 0, MASK8_2);
  ...
  static void decode7(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(112, ints, 1, 7, MASK8_7, tmp, 0, MASK8_1);
  ...
  static void decode9(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(144, ints, 7, 9, MASK16_9, tmp, 0, MASK16_7);
    for (int iter = 0, tmpIdx = 0, intsIdx = 144; iter < 16; ++iter, tmpIdx += 9, intsIdx += 7) {
      int l0 = tmp[tmpIdx + 0] << 2;
  ...
  static void decode10(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(160, ints, 6, 10, MASK16_10, tmp, 0, MASK16_6);
    for (int iter = 0, tmpIdx = 0, intsIdx = 160; iter < 32; ++iter, tmpIdx += 5, intsIdx += 3) {
      int l0 = tmp[tmpIdx + 0] << 4;
  ...
  static void decode11(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(176, ints, 5, 11, MASK16_11, tmp, 0, MASK16_5);
    for (int iter = 0, tmpIdx = 0, intsIdx = 176; iter < 16; ++iter, tmpIdx += 11, intsIdx += 5) {
      int l0 = tmp[tmpIdx + 0] << 6;
      l0 |= tmp[tmpIdx + 1] << 1;
  ...
  static void decode12(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(192, ints, 4, 12, MASK16_12, tmp, 0, MASK16_4);
    for (int iter = 0, tmpIdx = 0, intsIdx = 192; iter < 64; ++iter, tmpIdx += 3, intsIdx += 1) {
  ...
  static void decode13(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(208, ints, 3, 13, MASK16_13, tmp, 0, MASK16_3);
    for (int iter = 0, tmpIdx = 0, intsIdx = 208; iter < 16; ++iter, tmpIdx += 13, intsIdx += 3) {
  ...
  static void decode14(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(224, ints, 2, 14, MASK16_14, tmp, 0, MASK16_2);
    for (int iter = 0, tmpIdx = 0, intsIdx = 224; iter < 32; ++iter, tmpIdx += 7, intsIdx += 1) {
  ...
  static void decode15(PostingDecodingUtil pdu, int[] tmp, int[] ints) throws IOException {
    pdu.splitInts(240, ints, 1, 15, MASK16_15, tmp, 0, MASK16_1);
    for (int iter = 0, tmpIdx = 0, intsIdx = 240; iter < 16; ++iter, tmpIdx += 15, intsIdx += 1) {
