 ...
 *
 * @see org.apache.lucene.codecs.lucene98 package documentation for file format details.
 * @lucene.experimental
 */
public class Lucene98Codec extends Codec {
  ...
  private final PostingsFormat postingsFormat =
      new PerFieldPostingsFormat() {
        ...
        public PostingsFormat getPostingsFormatForField(String field) {
          return Lucene98Codec.this.getPostingsFormatForField(field);
        }
      };
  ...
  private final DocValuesFormat docValuesFormat =
      new PerFieldDocValuesFormat() {
        ...
        public DocValuesFormat getDocValuesFormatForField(String field) {
          return Lucene98Codec.this.getDocValuesFormatForField(field);
        }
      };
  ...
  private final KnnVectorsFormat knnVectorsFormat =
      new PerFieldKnnVectorsFormat() {
        ...
        public KnnVectorsFormat getKnnVectorsFormatForField(String field) {
          return Lucene98Codec.this.getKnnVectorsFormatForField(field);
        }
      };
   ...
   */
  public Lucene98Codec(Mode mode) {
    super("Lucene98");
    this.storedFieldsFormat =
        new Lucene90StoredFieldsFormat(Objects.requireNonNull(mode).storedMode);
    this.defaultPostingsFormat = new Lucene90PostingsFormat();
    this.defaultDVFormat = new Lucene90DocValuesFormat();
    this.defaultKnnVectorsFormat = new Lucene98HnswVectorsFormat();
  }
   ...
   *
   * <p>The default implementation always returns "Lucene98".
   *
   * <p><b>WARNING:</b> if you subclass, you are responsible for index backwards compatibility:
   * future version of Lucene are only guaranteed to be able to read the default implementation.
   */
