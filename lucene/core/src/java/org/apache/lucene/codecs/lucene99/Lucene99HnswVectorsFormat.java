...
public final class Lucene99HnswVectorsFormat extends KnnVectorsFormat {
   ...
   *     generated by this format to do the merge @Deprecated Use {@link
   *     #Lucene99HnswVectorsFormat(int, int)} instead, if you wish to use parallel merging supply
   *     the number of workers and the executor service to the index writer config via {@link
   *     IndexWriterConfig#setParallelMergeTaskExecutor(TaskExecutor)} and {@link
   *     IndexWriterConfig#setNumParallelMergeWorkers(int)}}
   */
  public Lucene99HnswVectorsFormat(
