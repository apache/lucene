 ...
 */
abstract class OffHeapQuantizedHalfByteVectorValues extends QuantizedByteVectorValues
  ...
  protected final int byteSize, numBytes;
  protected final ByteBuffer byteBuffer;
  protected int lastOrd = -1;
  protected final float[] scoreCorrectionConstant = new float[1];

  public static void decompressBytes(byte[] compressed, int numBytes) {
  ...
  public static void compressBytes(byte[] raw, byte[] compressed) {
  ...
  OffHeapQuantizedHalfByteVectorValues(int dimension, int size, IndexInput slice) {
    this.dimension = dimension;
    this.size = size;
    this.slice = slice;
    this.numBytes = (dimension + 1) >> 1;
    this.byteBuffer = ByteBuffer.allocate(dimension);
    this.byteSize = numBytes + Float.BYTES;
  ...
  static OffHeapQuantizedHalfByteVectorValues load(
  ...
  static class DenseOffHeapVectorValues extends OffHeapQuantizedHalfByteVectorValues {
  ...
  private static class SparseOffHeapVectorValues extends OffHeapQuantizedHalfByteVectorValues {
  ...
  private static class EmptyOffHeapVectorValues extends OffHeapQuantizedHalfByteVectorValues {
