 ...
 * @lucene.experimental
 */
public abstract class Lucene90CompressionMode {
   ...
   */
  public static final Lucene90CompressionMode FAST =
   ...
   */
  public static final Lucene90CompressionMode HIGH_COMPRESSION =
      new Lucene90CompressionMode() {
   ...
   */
  public static final Lucene90CompressionMode FAST_DECOMPRESSION =
      new Lucene90CompressionMode() {
  ...
  /** Sole constructor. */
  protected Lucene90CompressionMode() {}

  /** Create a new {@link Compressor} instance. */
  public abstract Lucene90Compressor newCompressor();

  /** Create a new {@link Decompressor} instance. */
  public abstract Lucene90Decompressor newDecompressor();

  private static final class LZ4FastCompressor extends Lucene90Compressor {
  ...
  private static final Lucene90Decompressor LZ4_DECOMPRESSOR =
  ...
  private static class DeflateCompressor extends Lucene90Compressor {
  ...
  private static final class DeflateDecompressor extends Lucene90Decompressor {
    ...
    @Override
    public Lucene90Decompressor clone() {
      return new Lucene90CompressionMode.DeflateDecompressor();
    }
  }

  private static final class LZ4HighCompressor extends Lucene90Compressor {
