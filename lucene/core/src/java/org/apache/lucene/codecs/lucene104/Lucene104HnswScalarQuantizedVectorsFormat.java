...
public class Lucene104HnswScalarQuantizedVectorsFormat extends KnnVectorsFormat {
  ...
  public Lucene104HnswScalarQuantizedVectorsFormat() {
    this(ScalarEncoding.UNSIGNED_BYTE, DEFAULT_MAX_CONN, DEFAULT_BEAM_WIDTH, DEFAULT_NUM_MERGE_WORKER, null);
  }
   ...
   */
  public Lucene104HnswScalarQuantizedVectorsFormat(
      ScalarEncoding encoding, int maxConn, int beamWidth, int numMergeWorkers, ExecutorService mergeExec) {
    super(NAME);
