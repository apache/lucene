...
public class Lucene105HnswScalarQuantizedVectorsFormat extends KnnVectorsFormat {
  ...
  public static final String NAME = "Lucene105HnswScalarQuantizedVectorsFormat";
  ...
  public Lucene105HnswScalarQuantizedVectorsFormat(
    ...
    this(
        encoding,
        Lucene105ScalarQuantizedVectorsFormat.ROTATION_DISABLED,
        maxConn,
        beamWidth,
        numMergeWorkers,
        mergeExec,
   ...
   * Lucene105ScalarQuantizedVectorsFormat#Lucene105ScalarQuantizedVectorsFormat(ScalarEncoding,
   * long)} for details.
   */
  public Lucene105HnswScalarQuantizedVectorsFormat(
      ScalarEncoding encoding,
      ...
      int tinySegmentsThreshold) {
    super(NAME);
    flatVectorsFormat = new Lucene105ScalarQuantizedVectorsFormat(encoding, rotationSeed);
