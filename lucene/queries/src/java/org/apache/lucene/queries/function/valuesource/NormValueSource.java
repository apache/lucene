 ...
 * TFIDFSimilarity} and the contribution of the TF needs to be 1 when the freq is 1 and the
 * contribution of the IDF needs to be 1 when docFreq == docCount == 1.
 *
 * @lucene.internal
 */
public class NormValueSource extends ValueSource {
  ...
  public FunctionValues getValues(Map<Object, Object> context, LeafReaderContext readerContext)
    ...
    final SimScorer simScorer =
        similarity.scorer(
            1f, new FieldStats(field, 1, 1, 1, 1), new TermStatistics(new BytesRef("bogus"), 1, 1));
