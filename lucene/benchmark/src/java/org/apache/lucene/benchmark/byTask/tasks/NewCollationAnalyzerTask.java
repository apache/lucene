...
/**
 * Task to support benchmarking collation. <br>
 *
 * <ul>
...
public class NewCollationAnalyzerTask extends PerfTask {
   ...
   *
   * @see <a href="http://site.icu-project.org/charts/collation-icu4j-sun">Comparison of
   *     implementations</a>
   */
  public enum Implementation {
    JDK("org.apache.lucene.collation.CollationKeyAnalyzer", "java.text.Collator"),
    ICU("org.apache.lucene.analysis.icu.ICUCollationKeyAnalyzer", "com.ibm.icu.text.Collator");
  ...
  static Analyzer createAnalyzer(Locale locale, Implementation impl) throws Exception {
    ...
    final Class<? extends Analyzer> clazz =
        Class.forName(impl.className).asSubclass(Analyzer.class);
