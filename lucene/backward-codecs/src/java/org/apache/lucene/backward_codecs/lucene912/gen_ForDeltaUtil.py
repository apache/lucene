...
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK16_1;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK16_2;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK16_4;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK16_5;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK16_6;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK16_7;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK16_8;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_1;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_12;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_13;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_14;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_15;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_16;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_2;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_3;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_4;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_5;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_6;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.MASK32_8;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.collapse16;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.collapse32;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.collapse8;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode1;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode10;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode11;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode17;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode18;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode19;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode2;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode20;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode21;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode22;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode23;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode24;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode3;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode4;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decode9;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.decodeSlow;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.encode;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.expand16;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.expand32;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.expand8;
import static org.apache.lucene.backward_codecs.lucene912.ForUtil.splitLongs;
...
def writeDecode(bpv, f):
    ...
    if next_primitive % bpv == 0:
        f.write(
            "  private static void decode%dTo%d(IndexInput in, long[] longs) throws IOException {\n"
            % (bpv, next_primitive)
        )
    else:
        f.write(
            "  private static void decode%dTo%d(IndexInput in, long[] tmp, long[] longs) throws IOException {\n"
            % (bpv, next_primitive)
        )
    if bpv == next_primitive:
        ...
        if remaining_bits == 0:
            f.write(
                "    splitLongs(in, %d, longs, %d, %d, MASK%d_%d, longs, %d, MASK%d_%d);\n"
                % (
                    bpv * 2,
                    next_primitive - bpv,
                    bpv,
            ...
            f.write(
                "    splitLongs(in, %d, longs, %d, %d, MASK%d_%d, tmp, 0, MASK%d_%d);\n"
                % (
                    bpv * 2,
                    next_primitive - bpv,
                    bpv,
            ...
            writeRemainder(
                bpv, next_primitive, remaining_bits, o, 128 / num_values_per_long - o, f
            )
    f.write("  }\n")
