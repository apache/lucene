 ...
 * @lucene.experimental
 */
public final class Lucene99HnswVectorsWriterV0 extends KnnVectorsWriter {

  private static final int DIRECT_MONOTONIC_BLOCK_SHIFT = 16;

  private static final long SHALLOW_RAM_BYTES_USED =
      RamUsageEstimator.shallowSizeOfInstance(Lucene99HnswVectorsWriterV0.class);
  ...
  public Lucene99HnswVectorsWriterV0(
    ...
    String metaFileName =
        IndexFileNames.segmentFileName(
            ...
            state.segmentSuffix,
            Lucene99HnswVectorsFormatV0.META_EXTENSION);

    String indexDataFileName =
        IndexFileNames.segmentFileName(
            state.segmentInfo.name,
            state.segmentSuffix,
            Lucene99HnswVectorsFormatV0.VECTOR_INDEX_EXTENSION);
    ...
    try {
      ...
      CodecUtil.writeIndexHeader(
          meta,
          Lucene99HnswVectorsFormatV0.META_CODEC_NAME,
          Lucene99HnswVectorsFormatV0.VERSION_START,
          state.segmentInfo.getId(),
          state.segmentSuffix);
      CodecUtil.writeIndexHeader(
          vectorIndex,
          Lucene99HnswVectorsFormatV0.VECTOR_INDEX_CODEC_NAME,
          Lucene99HnswVectorsFormatV0.VERSION_START,
          state.segmentInfo.getId(),
          state.segmentSuffix);
    } catch (Throwable t) {
