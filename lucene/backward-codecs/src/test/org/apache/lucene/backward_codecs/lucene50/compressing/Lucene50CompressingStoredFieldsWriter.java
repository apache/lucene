  ...
  public void writeField(FieldInfo info, IndexableField field) throws IOException {
    ...
    if (bytes != null) {
      ...
      if (number instanceof Byte || number instanceof Short || number instanceof Integer) {
        ...
        writeTLong(DirectoryUtil.wrapDataOutput(bufferedDocs), number.longValue());
      } else if (number instanceof Float) {
        writeZFloat(DirectoryUtil.wrapDataOutput(bufferedDocs), number.floatValue());
      } else if (number instanceof Double) {
        writeZDouble(DirectoryUtil.wrapDataOutput(bufferedDocs), number.doubleValue());
      } else {
