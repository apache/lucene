...
public class MemoryIndex {
  ...
  private void storeVectorValues(Info info, IndexableField vectorField) {
    ...
    switch (info.fieldInfo.getVectorEncoding()) {
      case BYTE:
        if (vectorField instanceof KnnByteVectorField) {
          KnnByteVectorField byteVectorField = (KnnByteVectorField) vectorField;
      ...
      case FLOAT32:
        if (vectorField instanceof KnnFloatVectorField) {
          KnnFloatVectorField floatVectorField = (KnnFloatVectorField) vectorField;
      ...
      default:
        throw new UnsupportedOperationException(
            "unknown vector encoding [" + info.fieldInfo.getVectorEncoding() + "]");
    }
  }
