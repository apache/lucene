...
public class TestSlicedIntBlockPool extends LuceneTestCase {
    public void testSingleWriterReader() {
        ...
        for (int j = 0; j < 2; j++) {
            ...
            MemoryIndex.SlicedIntBlockPool.SliceReader reader = new MemoryIndex.SlicedIntBlockPool.SliceReader(slicedIntBlockPool);
    ...
    private void assertReader(MemoryIndex.SlicedIntBlockPool.SliceReader reader, StartEndAndValues values) {
