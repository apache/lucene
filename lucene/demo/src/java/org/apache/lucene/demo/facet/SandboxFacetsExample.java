 ...
 * TODO: let's make it work as soon as we have something to show. Right now it is a copy paste of some other demo class.
 * */
public class SandboxFacetsExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("-------------------------");
    List<FacetResult> results = new SandboxFacetsExample().runSumAssociations();
